...
public class CustomSmallFireball extends Fireball {
    public CustomSmallFireball(EntityType<? extends SmallFireball> p_37364_, Level p_37365_) {
        super(p_37364_, p_37365_);
    }

    public CustomSmallFireball(Level p_37375_, LivingEntity p_37376_, double p_37377_, double p_37378_,
            double p_37379_) {
    ...
    protected void onHitEntity(EntityHitResult p_37386_) {
        ...
        if (!this.level.isClientSide) {
            ...
            if (!entity.hurt(this.damageSources().fireball(this, entity1), 6.5F)) {
    ...
    protected void onHitBlock(BlockHitResult p_37384_) {
        ...
        if (!this.level.isClientSide) {
            ...
            if (!(entity instanceof Mob)
                    || net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.level, entity)) {
